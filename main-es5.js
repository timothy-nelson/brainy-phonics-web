(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!-- Main content container -->\n<div class=\"rotate-message\">\n    <h2 class=\"title\">Brainy Phonics</h2>\n    <h2 class=\"subtitle\">Rotate to Play</h2>\n</div>\n<div class='jumbotron'>\n  <div class='container'>\n      <div class='row'>\n          <div class='col-sm-8 offset-sm-2'>\n              <router-outlet></router-outlet>\n          </div>\n      </div>\n  </div>\n</div>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesWordStructuresWordStructuresComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div id='background'>\n    <div id='main-body'>\n        <div class='column'> \n            <div class=\"row1\">\n                <button mat-icon-button class='category_button' id='base-ed' (mouseenter)='playAudio($event)' routerLink='/base-ed-details'></button>\n                <button mat-icon-button class='category_button' id='homophones' (mouseenter)='playAudio($event)' routerLink='/homophones-details'></button>\n            </div>\n\n            <div class=\"row2\">\n                <button mat-icon-button class='category_button' id='base-s' (mouseenter)='playAudio($event)' routerLink='/base-s-details'></button>\n                <button mat-icon-button class='category_button' id='homographs' (mouseenter)='playAudio($event)' routerLink='/homographs-details'></button>\n            </div>\n\n            <div class=\"row3\">\n                <button mat-icon-button class='category_button' id='comparative' (mouseenter)='playAudio($event)' routerLink='/comparative-details'></button>\n                <button mat-icon-button class='category_button' id='similies' (mouseenter)='playAudio($event)' routerLink='/similies-details'></button>\n            </div>\n\n            <div class=\"row4\">\n                <button mat-icon-button class='category_button' id='plurals' (mouseenter)='playAudio($event)' routerLink='/plurals-details'></button>\n                <button mat-icon-button class='category_button' id='personification' (mouseenter)='playAudio($event)' routerLink='/personification-details'></button>\n            </div>\n\n            <div class=\"row5\">\n                <button mat-icon-button class='category_button' id='possessives' (mouseenter)='playAudio($event)' routerLink='/possessives-details'></button>\n                <button mat-icon-button class='category_button' id='hyperbole' (mouseenter)='playAudio($event)' routerLink='/hyperbole-details'></button>\n            </div>\n\n            <div class=\"row6\">\n                <button mat-icon-button class='category_button' id='contractions' (mouseenter)='playAudio($event)' routerLink='/contractions-details'></button>\n                <button mat-icon-button class='category_button' id='euphemism' (mouseenter)='playAudio($event)' routerLink='/euphemism-details'></button>\n            </div>\n\n            <div class=\"row7\">\n                <button mat-icon-button class='category_button' id='compound-words' (mouseenter)='playAudio($event)' routerLink='/compound-details'></button>\n                <button mat-icon-button class='category_button' id='irony' (mouseenter)='playAudio($event)' routerLink='/irony-details'></button>\n            </div>\n\n            <div class=\"row8\">\n                <button mat-icon-button class='category_button' id='prefixes' (mouseenter)='playAudio($event)' routerLink='/prefixes-details'></button>\n                <button mat-icon-button class='category_button' id='onomatopoeia' (mouseenter)='playAudio($event)' routerLink='/onomatopoeia-details'></button>\n            </div>\n\n            <div class=\"row9\">\n                <button mat-icon-button class='category_button' id='suffixes' (mouseenter)='playAudio($event)' routerLink='/suffixes-details'></button>\n                <button mat-icon-button class='category_button' id='oxymoron' (mouseenter)='playAudio($event)' routerLink='/oxymoron-details'></button>\n            </div>\n\n            <div class=\"row10\">\n                <button mat-icon-button class='category_button' id='syllables' (mouseenter)='playAudio($event)' routerLink='/syllables-details'></button>\n                <button mat-icon-button class='category_button' id='rhyme' (mouseenter)='playAudio($event)' routerLink='/rhyme-details'></button>\n            </div>\n        </div>\n    </div>\n    <div id='side-menu'>\n        <button mat-icon-button class='icon' id='back' (click)='goBack()'></button>\n        <button mat-icon-button class='icon' id='home' routerLink='/home'></button>\n    </div>\n</div>";
    /***/
  },
  ...
  function srcAppAppComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\n    width: 1980px;\n    height: 1030px;\n    background-color: #6EC7D4;\n    margin: auto;\n}\n\n#side-menu {\n    width: 185px;\n    height: 1030px;\n    background-color: #C4E8E6;\n}\n\n.rotate-message {\n    position: fixed;\n    top: 0;\n    right: 0;\n    bottom: 0;\n    left: 0;\n    background-color: rgba(0, 0, 0, 0.85);\n    z-index: 1000;\n    color: #fff;\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n}\n\n.rotate-message .title {\n    margin: auto auto 0;\n    text-align: center;\n    font-size: 2.2rem;\n}\n\n.rotate-message .subtitle {\n    margin: 0 auto auto;\n    text-align: center;\n}\n\n@media (orientation: landscape) {\n    .rotate-message {\n      display: none;\n    }\n  }\n\n@media (orientation: portrait) {\n    .rotate-message {\n        display: -webkit-box;\n        display: flex;\n    }\n  }\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesAlphabetLearnAlphabetLearnComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\r\n  background-color: #FFFFFF !important;\r\n}\r\n\r\n#main-body {\r\n  width: 169.7vh;\r\n  height: 0vh;\r\n  padding-left: 22vh;\r\n  position: relative;\r\n}\r\n\r\n.back-button {\r\n    width: 9.5vh;\r\n    height: 9.5vh;\r\n    display: block;\r\n    position: absolute;\r\n    margin-left: 10vh;\r\n    margin-bottom: 3.5vh;\r\n    border: none;\r\n    margin-top: 45vh;\r\n}\r\n\r\n.after-button {\r\n    width: 9.5vh;\r\n    height: 9.5vh;\r\n    display: block;\r\n    position: absolute;\r\n    margin-left: 103vh;\r\n    margin-bottom: 3.5vh;\r\n    border: none;\r\n    margin-top: 45vh;\r\n}\r\n\r\n.letter {\r\n  font-size: 19.4vh;\r\n  margin-left: 49vh;\r\n  padding-top: 27.5vh;\r\n  cursor: pointer;\r\n  -webkit-transition: all .5s;\r\n  transition: all .5s;\r\n  -webkit-transform: scale(1) translate(5.5vh, 5vh);\r\n          transform: scale(1) translate(5.5vh, 5vh);\r\n}\r\n\r\n.animateLetter {\r\n  -webkit-transition: all .5s;\r\n  transition: all .5s;\r\n  -webkit-transform: translate(12vh, 3vh) scale(1.12) !important;\r\n          transform: translate(12vh, 3vh) scale(1.12) !important;\r\n}\r\n\r\n/* Buttons */\r\n\r\n#forward {\r\n    background: url('forward.png') no-repeat scroll 0 0 transparent;\r\n    background-size: 9.5vh 9.5vh;\r\n}\r\n\r\n.bottom {\r\n  -webkit-transform: translateY(13vh);\r\n          transform: translateY(13vh);\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesAlphabetQuizAlphabetQuizComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\n  background-color: #FFFFFF !important;\n}\n\n#main-body {\n  width: 169.7vh;\n  height: 0vh;\n  padding-left: 22vh;\n  position: relative;\n}\n\n.column {\n  float: left;\n}\n\n#letter, \n#letter2, \n#letter3, \n#letter4 {\n    font-size: 19.4vh;\n    cursor: pointer;\n}\n\n#letter,\n#letter3 {\n  margin-left: 55vh;\n}\n\n#letter2,\n#letter4 {\n  margin-left: 35vh;\n}\n\n#letter,\n#letter2 {\n  margin-top: 18vh;\n}\n\n.letter-temp,\n.letter-temp2,\n.letter-temp3,\n.letter-temp4 {\n  color: white;\n}\n\n.animateLetter1 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(22vh, 10vh) scale(1.12) !important;\n          transform: translate(22vh, 10vh) scale(1.12) !important;\n}\n\n.animateLetter2 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(-22vh, 10vh) scale(1.12) !important;\n          transform: translate(-22vh, 10vh) scale(1.12) !important;\n}\n\n.animateLetter3 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(22vh, -10vh) scale(1.12) !important;\n          transform: translate(22vh, -10vh) scale(1.12) !important;\n}\n\n.animateLetter4 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(-22vh, -10vh) scale(1.12) !important;\n          transform: translate(-22vh, -10vh) scale(1.12) !important;\n}\n\n/* Buttons */\n\n#forward {\n    background: url('forward.png') no-repeat scroll 0 0 transparent;\n    background-size: 9.5vh 9.5vh;\n}\n\n.bottom {\n  -webkit-transform: translateY(13vh);\n          transform: translateY(13vh);\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesAlphabetQuizAlphabetQuizComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AlphabetQuizComponent = class AlphabetQuizComponent {
      ...
      pickRandom(current) {
        var copiedList = [...this.letterList]; // remove selected alphabet from list
  ...
  function srcAppPagesCoinsCoinsComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\n    background-color: #FFFFFF !important;\n}\n\n#side-menu {\n    background-color: #6EC7D4 !important;\n}\n\n#main-body {\n    width: 169.7vh;\n    height: 0vh;\n    padding-left: 40vh;\n    position: relative;\n}\n\n.column {\n    float: left;\n    text-align: right;\n    width: 100%;\n    height: 92.5vh;\n    -webkit-transform: translateX(-21vh);\n            transform: translateX(-21vh);\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n            align-items: center;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-flow: column;\n}\n\n.row > img{\n    padding: 2vh;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesHomeHomeComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#main-body {\n  width: 169.7vh;\n  height: 0vh;\n  padding-left: 40vh;\n  position: relative;\n}\n\n#side-menu {\n  background: url('home-side-bar.png') no-repeat scroll 0 0 transparent;\n  background-size: 17vh 100vh;\n}\n\n#background {\n    background-color: #FFFFFF !important;\n}\n\n/* Phonics Categories */\n\n#pre-k {\n    background: url('pre_k.png') no-repeat scroll transparent;\n    background-size: 33vh;\n    margin-left: 32vh;\n    width: 33vh;\n    height: 34vh;\n    cursor: pointer;\n}\n\n#kindergarten {\n    background: url('kindergarten.png') no-repeat scroll transparent;\n    background-size: 33vh;\n    margin-left: 23vh;\n    width: 33vh;\n    height: 34vh;\n    cursor: pointer;\n}\n\n#first {\n    background: url('1st.png') no-repeat scroll transparent;\n    background-size: 30vh;\n    margin-left: 6vh;\n    width: 30vh;\n    height: 16vh;\n    cursor: pointer;\n}\n\n#second {\n    background: url('2nd.png') no-repeat scroll transparent;\n    background-size: 30vh;\n    margin-left: 26vh;\n    width: 30vh;\n    height: 16vh;\n    cursor: pointer;\n}\n\n#third {\n    background: url('3rd.png') no-repeat scroll transparent;\n    background-size: 30vh;\n    margin-left: 25vh;\n    width: 30vh;\n    height: 16vh;\n    cursor: pointer;\n}\n\n#phonics {\n    background: url('phonics_logo.png') no-repeat scroll transparent;\n    background-size: 42vh;\n    height: 36.5vh;\n    width: 42vh;\n    cursor: pointer;\n}\n\n#word-structures {\n  background: url('word_structures.png') no-repeat scroll transparent;\n  background-size: 46.5vh;\n  margin-left: 12vh;\n  height: 36.5vh;\n  width: 47vh;\n  cursor: pointer;\n}\n\n#secret-stuff {\n  background: url('secret_stuff.png') no-repeat scroll transparent;\n  background-size: 36vh;\n  -webkit-transform: translate(-24vh, -18.3vh);\n          transform: translate(-24vh, -18.3vh);\n  width: 36vh;\n  height: 18vh;\n  cursor: pointer;\n}\n\n#nobodys-better {\n  background: url('nobodys_better.png') no-repeat scroll transparent;\n  background-size: 36vh;\n  width: 36vh;\n  height: 18vh;\n  -webkit-transform: translate(12vh, 0.5vh);\n          transform: translate(12vh, 0.5vh);\n  cursor: pointer;\n}\n\n.button {\n    margin-top: 2vh;\n    border: none;\n}\n\n.container {\n  margin-left: -18vh;\n}\n\n/* Clear floats after the columns */\n\n.column:after {\n  content: \"\";\n  display: table;\n  clear: both;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesLoginLoginComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#main-body {\n    width: 100vw;\n    height: 0vh;\n    /* padding-left: 18vh; */\n    position: relative;\n  }\n  \n  #side-menu {\n    background: url('home-side-bar.png') no-repeat scroll 0 0 transparent;\n    background-size: 17vh 100vh;\n  }\n  \n  #background {\n      background-color: #d5eced !important;\n  }\n  \n  .container {\n      background: #d5eced;\n      padding: 4.5vh 1.5rem;\n      height: 91vh;\n      width: calc(100% - 3rem);\n      text-align: center;\n  }\n  \n  h2 {\n    color: #2c3e50;\n    font-size: 1.5rem;\n    margin: 2.5vh;\n  }\n  \n  .password {\n    margin: 2.5vh;\n  }\n  \n  .placeholder {\n      border: #797979 0.3vh dotted;\n      width: 8vh;\n      height: 8vh;\n      border-radius: 1.1vh;\n      margin: 1.1vh;\n      cursor: pointer;\n      display: inline-block;\n  }\n  \n  .selected-image {\n      width: 100%;\n      height: 100%;\n      border-radius: 1.1vh;\n      margin-bottom: 1.4vh;\n      /* border: white 0.3vh solid;; */\n  }\n  \n  .image-container {\n      -webkit-box-orient: horizontal;\n      -webkit-box-direction: normal;\n              flex-direction: row;\n      display: -webkit-box;\n      display: flex;\n      max-width: 80%;\n      margin: 0 auto;\n      max-height: 52vh;\n      flex-wrap: wrap;\n      -webkit-box-pack: center;\n              justify-content: center;\n  }\n  \n  @media (max-width: 800px ){\n        .image-container {\n            max-width: 100%;\n        }\n    }\n  \n  .image {\n      height: 8vh;\n      width: 8vh;\n      border-radius: 1.2vh;\n      cursor: pointer;\n      border: transparent 0.5vh solid;\n      margin: 1vh;\n  }\n  \n  #submit {\n    background: #4caf82;\n    color: #fff;\n    border: none;\n    border-radius: 1.1vh;\n    padding: 2vh 4vh;\n    font-family: 'Avenir', Helvetica, Arial, sans-serif !important;\n    font-weight: 700;\n    font-size: 3vh;\n    cursor: pointer;\n    margin-top: 1.5vh;\n  }\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LoginComponent = class LoginComponent {
      constructor(userService, router) {
        ...
        for (let i = 0; i < 10; i++) {
          this.imgs.push({
            url: "../../../assets/img/login/".concat(i, ".png"),
            id: "".concat(i)
          });
        }
      }
  ...
  function srcAppPagesPhonemeLearnPhonemeLearnComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\n\tbackground-color: #FFFFFF !important;\n}\n\n#side-menu {\n\tbackground-color: #6EC7D4 !important;\n}\n\n#main-body {\n  width: 169.7vh;\n  height: 0vh;\n  padding-left: 40vh;\n  position: relative;\n}\n\n.column {\n  float: left;\n  text-align: center;\n  width: 48vh;\n  -webkit-transform: translateX(-21vh);\n          transform: translateX(-21vh);\n}\n\n.column .text {\n  font-size: 4.8vh;\n  cursor: pointer;\n  position: absolute;\n  top: 55vh;\n  z-index: 999;\n  margin-left: 21vh;\n}\n\n.letter {\n  font-size: 19.4vh;\n  padding-top: -10vh;\n  margin-left: 44vh;\n  cursor: pointer;\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n\n.letter.one {\n  -webkit-transform: translate(11vh, 3vh);\n          transform: translate(11vh, 3vh);\n}\n\n.letter.two {\n  -webkit-transform: translate(5.5vh, 3vh);\n          transform: translate(5.5vh, 3vh);\n}\n\n.letter.three {\n  -webkit-transform: translate(5vh, 3vh);\n          transform: translate(5vh, 3vh);\n}\n\n::ng-deep span {\n  color: red;\n}\n\n.back-button {\n    width: 9.5vh;\n    height: 9.5vh;\n    display: block;\n    position: absolute;\n    margin-left: 10vh;\n    margin-bottom: 3.5vh;\n    border: none;\n    margin-top: 15vh;\n}\n\n.after-button {\n    width: 9.5vh;\n    height: 9.5vh;\n    display: block;\n    position: absolute;\n    margin-left: 103vh;\n    margin-bottom: 3.5vh;\n    border: none;\n    margin-top: 15vh;\n}\n\n.row {\n  padding-left: 10vh;\n}\n\n/* Clear floats after the columns */\n\n.row:after {\n  content: \"\";\n  display: table;\n  clear: both;\n}\n\n.word-image {\n  margin-top: 22vh;\n  cursor: pointer;\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1) !important;\n          transform: scale(1) !important;\n  width: 70%;\n}\n\n.animate {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: translate(-21vh, -1vh) scale(1.12) !important;\n          transform: translate(-21vh, -1vh) scale(1.12) !important;\n}\n\n.animate-one {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: translate(18vh, 3vh) scale(1.12) !important;\n          transform: translate(18vh, 3vh) scale(1.12) !important;\n}\n\n.animate-two {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: translate(12vh, 3vh) scale(1.12) !important;\n          transform: translate(12vh, 3vh) scale(1.12) !important;\n}\n\n.animate-three {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: translate(11vh, 3vh) scale(1.12) !important;\n          transform: translate(11vh, 3vh) scale(1.12) !important;\n}\n\n/* Text */\n\nh2 {\n  font-size: 20px;\n}\n\nh2 {\n  font-weight: lighter;\n}\n\np {\n  font-size: 14px;\n}\n\n::ng-deep span {\n  color: red;\n}\n\n/* Buttons */\n\n#forward {\n    background: url('forward.png') no-repeat scroll 0 0 transparent;\n    background-size: 9.5vh 9.5vh;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesPhonemeQuizPhonemeQuizComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#background {\n\tbackground-color: #FFFFFF;\n}\n\n#side-menu {\n\tbackground-color: #6EC7D4;\n}\n\n#main-body {\n  width: 169.7vh;\n  height: 0vh;\n  padding-left: 17vh;\n  position: relative;\n}\n\n.column {\n  float: left;\n}\n\n.puzzle-pane {\n    height: 900px;\n    margin: 0;\n    padding: 0;\n    text-align: center;\n    width: 48vh;\n    background-color: #ddf6f8;\n}\n\n.puzzle {\n    position: relative;\n    text-align: left;\n    margin: auto;\n    width: 36vh;\n    height: 48vh;\n    background-color: #d3ecee;\n}\n\n.puzzle-image {\n    position: absolute;\n    top: 0;\n    width: 36vh;\n    height: 48vh;\n    opacity: 0;\n}\n\n.visible {\n    opacity: 1;\n}\n\n.letter {\n  font-size: 19.4vh;\n  padding-top: -10vh;\n  padding-bottom: 10vh;\n  cursor: pointer;\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n\n::ng-deep span {\n  color: red;\n}\n\n/* Clear floats after the columns */\n\n.row:after {\n  content: \"\";\n  display: table;\n  clear: both;\n}\n\n.word-image {\n  cursor: pointer;\n  margin-top: 6vh;\n  width: 30vh;\n  height: 30vh;\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n\n.word-image-top {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n}\n\n.word-image-bottom {\n    margin-left: 10vh;\n    margin-right: 10vh;\n}\n\n.animate {\n  -webkit-transition: all .75s;\n  transition: all .75s;\n  -webkit-transform: scale(1.12);\n          transform: scale(1.12);\n}\n\n.animate-default {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n\n.animate-one {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1.12);\n          transform: scale(1.12);\n}\n\n.animate-two {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1.12);\n          transform: scale(1.12);\n}\n\n.animate-three {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1.12);\n          transform: scale(1.12);\n}\n\n.animate-puzzle {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n  -webkit-transform: scale(1.12);\n          transform: scale(1.12);\n}\n\n.ex-temp1,\n.ex-temp2,\n.ex-temp3 {\n  opacity: 0;\n}\n\n.animateEx1 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translateY(17vh) scale(1.12) !important;\n          transform: translateY(17vh) scale(1.12) !important;\n}\n\n.animateEx2 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(21vh, -17vh) scale(1.12) !important;\n          transform: translate(21vh, -17vh) scale(1.12) !important;\n}\n\n.animateEx3 {\n  -webkit-transition: all 0.5s linear;\n  transition: all 0.5s linear;\n  -webkit-transform: translate(-21vh, -17vh) scale(1.12) !important;\n          transform: translate(-21vh, -17vh) scale(1.12) !important;\n}\n\n/* Text */\n\nh2 {\n  font-size: 20px;\n}\n\nh2 {\n  font-weight: lighter;\n}\n\np {\n  font-size: 14px;\n}\n\n/* Buttons */\n\n#forward {\n    background: url('forward.png') no-repeat scroll 0 0 transparent;\n    background-size: 9.5vh 9.5vh;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesPhonemeQuizPhonemeQuizComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let PhonemeQuizComponent = class PhonemeQuizComponent {
      constructor(transferService, phonemeProgressService, router, location, activatedRoute, phonemesService, changeDetectorRef) {
        ...
        var LCG = s => () => (Math.pow(2, 31) - 1 & (s = Math.imul(48271, s))) / Math.pow(2, 31); // Generate seed for rng based on phoneme id
  ...
  function srcAppPagesPuzzlePuzzleComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let PuzzleComponent = class PuzzleComponent {
      constructor(transferService, location, router, activatedRoute) {
        ...
        this.router = router;
        this.activatedRoute = activatedRoute;
        let from = this.activatedRoute.snapshot.queryParamMap.get('from'); // get phoneme data
  ...
  function srcAppPagesWordStructuresWordStructuresComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#main-body {\n    width: 169.7vh;\n    height: 0vh;\n    padding-left: 40vh;\n    position: relative;\n  }\n  \n  #background {\n      background-color: #FFFFFF !important;\n      background: url('word_structures_bkg.png') no-repeat scroll transparent;\n    background-position: center top;\n    background-size: 148vh;\n  }\n  \n  #base-ed{\n    background: url('base_words_ed.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 38vh;\n    margin-left: -9vh;\n    cursor: pointer;\n  }\n  \n  #base-s{\n    background: url('base_words_s.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 35vh;\n    width: 35vh;\n    margin-left: -9.5vh;\n    cursor: pointer;\n  }\n  \n  #comparative{\n    background: url('comparative_endings.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 42vh;\n    width: 42vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #plurals{\n    background: url('plurals.png') no-repeat scroll transparent;\n    background-position: center;\n    width: 22vh;\n    background-size: 22vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #possessives{\n    background: url('possessives.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 26vh;\n    width: 26vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #contractions{\n    background: url('contractions.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 28vh;\n    width: 28vh;\n    margin-left: -9.5vh;\n    cursor: pointer;\n  }\n  \n  #compound-words{\n    background: url('compound_words.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 35vh;\n    width: 35vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #prefixes{\n    background: url('prefixes.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 25vh;\n    width: 25vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #suffixes{\n    background: url('suffixes.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 25vh;\n    width: 25vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #syllables{\n    background: url('syllables.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 26vh;\n    width: 26vh;\n    margin-left: -10vh;\n    cursor: pointer;\n  }\n  \n  #homophones{\n    background: url('homophones.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 26vh;\n    width: 26vh;\n    margin-left: 15vh;\n    cursor: pointer;\n  }\n  \n  #homographs{\n    background: url('homographs.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 26vh;\n    width: 26vh;\n    margin-left: 18vh;\n    cursor: pointer;\n  }\n  \n  #similies{\n    background: url('similies.png') no-repeat scroll transparent;\n    background-position: bottom;\n    background-size: 40vh;\n    width: 40vh;\n    height: 4vh;\n    margin-left: 12vh;\n    cursor: pointer;\n  }\n  \n  #personification{\n    background: url('personification.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 27vh;\n    width: 27vh;\n    margin-left: 31.5vh;\n    cursor: pointer;\n  }\n  \n  #hyperbole{\n    background: url('hyperbole.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 20vh;\n    width: 20vh;\n    margin-left: 27.5vh;\n    cursor: pointer;\n  }\n  \n  #euphemism{\n    background: url('euphemism.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 23vh;\n    width: 23vh;\n    margin-left: 25vh;\n    cursor: pointer;\n  }\n  \n  #irony{\n    background: url('irony.png') no-repeat scroll transparent;\n    background-position: left;\n    background-size: 20vh;\n    width: 15vh;\n    margin-left: 19vh;\n    cursor: pointer;\n  }\n  \n  #onomatopoeia{\n    background: url('onomatopoeia.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 28vh;\n    width: 28vh;\n    margin-left: 28.5vh;\n    cursor: pointer;\n  }\n  \n  #oxymoron{\n    background: url('oxymoron.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 24vh;\n    width: 24vh;\n    margin-left: 28.5vh;\n    cursor: pointer;\n  }\n  \n  #rhyme{\n    background: url('rhyme.png') no-repeat scroll transparent;\n    background-position: center;\n    background-size: 40vh;\n    width: 40vh;\n    margin-left: 28vh;\n    cursor: pointer;\n  }\n  \n  .row1, .row2, .row3, .row4, .row5, .row6, .row7, .row8, .row9, .row10 {\n    float: center;\n  }\n  \n  .category_button{\n    width: 38vh;\n    height: 5vh;\n    margin: 1vh 20vh 0vh 0vh;\n    border: none;\n    margin-left: auto;\n  }\n  \n  .column{\n    padding-top: 20vh;\n  }\n  \n  img {\n      height: 30vh;\n      margin: 30vh 0vh 0vh 10vh;\n  }\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppServicesProgressServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ProgressService = class ProgressService {
      ...
      addIncorrectAnswer(key) {
        let input; // If phoneme isn't mastered
  ...
  /***/
  function srcAssetsJsonIncorrectSchwasJson(module) {
